...
<div class="investors-archive">
    ...
    <div class="filter-search">
        <form id="searchform" method="get">
            <input type="text" id="searchFilter" name="searcharea" placeholder="<?php esc_attr_e('Free text search', 'cpm_investors'); ?>" value="<?php echo get_search_query(), esc_attr($_GET['searcharea'] ?? ''); ?>" />
